...
import { n as dispatchDiscreteCustomEvent, r as require_jsx_runtime, t as Primitive } from "./dist-H7wdwrLQ.js";
import { n as useCallbackRef, t as useLayoutEffect2 } from "./dist-jxMVbu8B.js";
import { t as require_react_dom } from "./react-dom-hdrE4QLd.js";
import { a as useComposedRefs } from "./dist-EKb03w6L.js";
import { i as composeEventHandlers } from "./dist-CbvMCYJy.js";
...
var DismissableLayer = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$1(function DismissableLayer2(props, forwardedRef) {
	...
	import_react.useEffect(() => {
		const handleUpdate = /* @__PURE__ */ __name$1(() => force({}), "handleUpdate");
...
__name$1(useDismissableLayerSurface, "useDismissableLayerSurface");
var IS_TRUE = /* @__PURE__ */ __name$1(() => true, "IS_TRUE");
function usePointerDownOutside(onPointerDownOutside, args) {
	...
	import_react.useEffect(() => {
		...
		__name$1(resetOutsideInteraction, "resetOutsideInteraction");
		function isOutsideInteractionIntercepted() {
			return Array.from(interceptedOutsideInteractionEventsRef.current.values()).some(Boolean);
		}
		__name$1(isOutsideInteractionIntercepted, "isOutsideInteractionIntercepted");
		...
		__name$1(handleInteractionCapture, "handleInteractionCapture");
		function handleInteractionBubble(event) {
			if (isPointerDownOutsideRef.current) interceptedOutsideInteractionEventsRef.current.set(event.type, false);
		}
		__name$1(handleInteractionBubble, "handleInteractionBubble");
		const handlePointerDown = /* @__PURE__ */ __name$1((event) => {
			if (event.target && !isPointerInsideReactTreeRef.current) {
				...
				__name$1(handleAndDispatchPointerDownOutsideEvent2, "handleAndDispatchPointerDownOutsideEvent");
	...
	return { onPointerDownCapture: /* @__PURE__ */ __name$1(() => isPointerInsideReactTreeRef.current = true, "onPointerDownCapture") };
}
__name$1(usePointerDownOutside, "usePointerDownOutside");
function useFocusOutside(onFocusOutside, ownerDocument = globalThis?.document) {
	const handleFocusOutside = useCallbackRef(onFocusOutside);
	const isFocusInsideReactTreeRef = import_react.useRef(false);
	import_react.useEffect(() => {
		const handleFocus = /* @__PURE__ */ __name$1((event) => {
	...
	return {
		onFocusCapture: /* @__PURE__ */ __name$1(() => isFocusInsideReactTreeRef.current = true, "onFocusCapture"),
		onBlurCapture: /* @__PURE__ */ __name$1(() => isFocusInsideReactTreeRef.current = false, "onBlurCapture")
	};
}
__name$1(useFocusOutside, "useFocusOutside");
function dispatchUpdate() {
	const event = new CustomEvent(CONTEXT_UPDATE);
	document.dispatchEvent(event);
}
__name$1(dispatchUpdate, "dispatchUpdate");
